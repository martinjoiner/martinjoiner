...
<div class="cvSecondaryCol">
	...
	<p>Responsive web design, accessibility, UX, DX.</p>
...
<div class="cvPrimaryCol">
	...
	<div class="contactDetails">Martin Joiner &nbsp;&nbsp; Bristol, UK &nbsp;&nbsp; <span id="emailPlaceholder"></span> &nbsp;&nbsp; <?=$phone?></div>
    ...
    <div class="projectWrap">
        <h3>RCoA Lifelong Learning Platform <span class="dRange">2017 - 2019</span></h3>
	...
	<div class="projectWrap">
		...
		<ul class="outLink">
            <li>&ndash; <a target=_blank href="https://poetrypin.info/">poetrypin.info</a></li>
		</ul>
	</div>
	...
	<div class="projectWrap">
		<h3>Horizon Data <span class="dRange">2015</span></h3>

		<p class="role">Via my role as Senior front-end developer at <a href="http://www.somoglobal.com/">Somo Global</a> (2015)</p>

		<p>I was responsible for <span class="tag tag-js" data-tag-family="tag-js">JavaScript</span>, CSS and some <span class="tag tag-php" data-tag-family="tag-php">PHP</span> (Symfony framework) on a CSR charity project. It involved complicated data visualisation in the form of charts and interactive maps. Was live at www.horizondata.net.</p>
	...
	<?php
	$carmenData = '<p class="role">Via my role as Senior web developer at <a href="http://carmendata.co.uk/">Carmen Data Ltd</a> (2012-2015)</p>';
	?>

	<div class="projectWrap">
		<h3>Ford Quote <span class="dRange">2015</span></h3>
	...
	<div class="projectWrap">
		...
		<p>Long-established and trusted but quite niche and ugly. Continual improvement of products and taxation decision 
		tools. Backwards compatibility for executives still running IE7 on XP. Performs complex financial projections and 
...
<div class="cvFullWidthCol">
	...
	<h3>Web designer at Wessex Malthouse Design <span class="dRange">2008 &ndash; 2009</span></h3>

	<p>Working alongside graphic design for print. Introduced new web department delivering new builds and 
